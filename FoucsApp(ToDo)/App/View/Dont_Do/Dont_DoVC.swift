...
class Dont_DoVC: UIViewController {
...
//MARK: - Extension
extension Dont_DoVC : UITableViewDelegate{
...
extension Dont_DoVC : UITableViewDataSource{
...
extension Dont_DoVC: AddTaskDelegate {
   
    

    func didAddTask(name: String, description: String, date: Date) {
        // Create a new task
        let newTask = DontDo(context: context)
        newTask.name = name
...
extension Dont_DoVC{
    ...
    func getAllItems() {
        do {
            tasks = try context.fetch(DontDo.fetchRequest())
    ...
    func createItem(name: String, desc: String) {
        let newItem = DontDo(context: context)
        newItem.name = name
        newItem.desc = desc
    ...
    func updateItem(item: DontDo, newName: String, newDescription: String) {
        item.name = newName
