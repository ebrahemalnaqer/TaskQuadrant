...
//MARK: - Extension
extension DoFirstVC : UITableViewDelegate{
...
extension DoFirstVC : UITableViewDataSource{
...
extension DoFirstVC: AddTaskDelegate {
...
extension DoFirstVC {
    ...
    func updateItem(item: Task, newName: String, newDescription: String) {
        item.name = newName
